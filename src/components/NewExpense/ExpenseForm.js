  ...
  */
  ...
  return (
    <form onSubmit={submitHandler}>
      ...
      <div className="new-expense__control">
      <label>Amount</label>
      <input type="number" min="0.01" step="0.01" value={expenseAmount} onChange={expenseAmountChangeHandler}/>
    </div>
    <div className="new-expense__control">
    <label>Date</label>
    <input type="date" min="2019-01-01" max="2022-12-12" value={expenseDate} onChange={expenseDateChangeHandler}/>
    </div>
    </div>
